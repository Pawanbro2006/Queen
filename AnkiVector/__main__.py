...
PM_START_TEXT = """
Hello there, I'm Queen
I'm a Powerful group manager bot With Cool Modules. Made by [MW SONGS](t.me/MW_SONG_GRUP)
...
buttons = [
    [
        InlineKeyboardButton(
            text="📢Updates Channel", url="https://t.me/QueenUpdates"
        ),
        InlineKeyboardButton(
            text="👥 Support Group", url="https://t.me/QueenSupport_Official"
        ),
    ],
    [
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            text="➕ Add Queen to your group ➕",
            url="t.me/TheQueenXbot?startgroup=true",
        ),
    ],
]

ANKIVECTOR_IMG = "CAACAgUAAx0CXTXUBwACBDVg_5iWG8WczmlJQkj_sK3BTPOMBgACcAIAAsJ9aVfc3YowHvn_0CAE"
...
def AnkiVector_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n Join [QueenUpdates](https://t.me/QueenUpdates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Queen Support](https://t.me/QueenSupport_Official).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
